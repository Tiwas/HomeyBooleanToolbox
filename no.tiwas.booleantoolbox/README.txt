...
NEW IN BETA: State Capture Device - Dynamically capture device states at runtime using templates. Store multiple named states and use stack-based push/pop operations for temporary state management. See docs/state-capture-device.html for details.